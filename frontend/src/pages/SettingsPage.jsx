  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Card>
        ...
        <SettingRow label="Remote link opening" desc="Allow bot to open URLs on PC (/open)" control={<Toggle on={config?.remote_open_allowed} onChange={v => togglePermission("remote_open_allowed", v)} loading={updatingPerms.remote_open_allowed} />} />
  ...
  return (
    <nav style={{ display: "flex", flexDirection: "column", gap: 2 }}>
      {NAV_ITEMS.map(({ id, icon, label, sub }, idx) => {
        ...
        const showDivider = idx === 4; // divider before Updates+About+Developer
        return (
          <div key={id}>
